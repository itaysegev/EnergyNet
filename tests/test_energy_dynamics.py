...
class TestDeterministicProduction(unittest.TestCase):
    def setUp(self):
        ...
        self.dynamics: DeterministicProduction = DeterministicProduction(model_parameters=model_params)
    ...
    def test_missing_parameters(self):
        with self.assertRaises(AssertionError):
            ...
            DeterministicProduction(model_parameters=incomplete_params)
...
class TestDeterministicConsumption(unittest.TestCase):
    def setUp(self):
        ...
        self.dynamics: DeterministicConsumption = DeterministicConsumption(model_parameters=model_params)
    ...
    def test_missing_parameters(self):
        with self.assertRaises(AssertionError):
            ...
            DeterministicConsumption(model_parameters=incomplete_params)
